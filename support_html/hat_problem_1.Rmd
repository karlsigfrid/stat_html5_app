...
$E[X_2]$ is a bit trickier, but we can manage that too. Person 2 gets his hat if first person 1 does not take person 2's hat (probability 2/3) and then person 2 takes his hat (probability 1/2), so the probability of this sequence of events is $P(X_2=1)=\cfrac{2}{3} \cdot \cfrac{1}{2}=\cfrac{1}{3}$.
...
Finally, person 3 gets her hat if the first two people did not get person 3's hat. The first two people have a 2/3 probability of taking person 3's hat, so the probability that they leave it for her is 1/3, so $P(X_3=1)=\cfrac{1}{3}$ and
