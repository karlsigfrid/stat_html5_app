---
title: "How to calculate correlation when you know the distribution"
output:
  html_document:
    df_print: paged
...
However, in this case we don't have observations of $X$ and $Y$. Instead we have their theoretical distributions, which means that we know the probabilities that the variables take certain values. When we know the distribution of the variables, we use the following formulas to calculate the theoretical covariance and variances:
...
We return to the original formula for the correlation. Remember that $\sigma_x$ is the square root of the variance of $X$.
